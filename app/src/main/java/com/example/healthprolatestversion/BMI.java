...
public class BMI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView btnBackToDashboard = findViewById(R.id.bmiback);
        ImageView bmihistorybtn = findViewById(R.id.bmihistory);
        ...
        bmihistorybtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BMI.this, BMIHistory.class);
                startActivity(intent);
                finish();
